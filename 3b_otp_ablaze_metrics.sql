...
left outer join (select * from dse.billing_period_end_f 
              where billing_period_nbr = 1 
              and billing_period_end_date >=20181114) bp1
...
left outer join (select * from dse.billing_period_end_f 
            ...
            and billing_period_end_date >=20181114) bp2
...
where alloc.allocation_region_date between nf_dateadd(nf_dateint_today() , -3) and nf_dateint_today() 
